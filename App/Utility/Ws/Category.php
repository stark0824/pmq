...
// | Date:	2022/5/9
// +----------------------------------------------------------------------
// | Desc:	服务端主动推送给客户端的消息，只使用类型，不接收参数
// |        v1: 主要功能推送消息红点
// |        v2: 统计消息红点数，主动推送给客户端
// |        v3-v4: 客服IM
// +----------------------------------------------------------------------
...
class Category
{
    ...
    {
        return array_merge(self::$msgTypeV1, self::$msgTypeV2, self::$msgTypeV3, self::$msgTypeV4);
    }
    ...
    static $headUrl = 'https://resourcecp.oss-cn-beijing.aliyuncs.com/...';
